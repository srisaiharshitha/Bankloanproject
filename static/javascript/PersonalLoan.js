    ...
    function backToDetails(){ document.getElementById('formSection').style.display = 'none'; document.getElementById('detailsSection').style.display = 'block'; document.getElementById('successMsg').style.display = 'none'; document.getElementById('loanForm').reset(); window.scrollTo({top:0, behavior:'smooth'}); }
